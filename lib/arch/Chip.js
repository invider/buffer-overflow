...
class Chip {
    ...
    trigger(cpu, handler, stack) {
        ...
        switch(handler) {
            case 'up': return cpu.sensors.trigger['up']
            case 'left': return cpu.sensors.trigger['left']
            case 'down': return cpu.sensors.trigger['down']
            case 'right': return cpu.sensors.trigger['right']
